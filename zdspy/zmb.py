...
class ZMB_MPOB_CE:
    ...
    def __init__(self, data, num):
        ...
        self.item_id = d.UInt16(self.data, 0x8)
        self.unknown1 = d.UInt32(self.data, 0xA)
    ...
    def save(self) -> bytearray:
        ...
        buffer = d.w_UInt16(buffer, 0x8, self.item_id)
        buffer = d.w_UInt32(buffer, 0xA, self.unknown1)
...
class ZMB_PLYR_CE:
    ...
    def __init__(self, data, num):
        ...
        debug_print(str(self) + " [" + str(num) + "]")
        # debug_print("PLYR_CE:"+" HEX:" + str(self.data.hex()) + " [:"+str(num)+"] ")
...
class ZMB_CAME(gh.ZDS_GenericElementHeaderRaw):
    ...
    def init(self):
        ...
        if len(self.data) > self.header_size:
            debug_print("[CAMERA] SECTION HAS DATA! WOOOOH!")
